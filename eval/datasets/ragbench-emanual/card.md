...
- **Size:** 222 documents (every distinct document in train, validation and test), 264 queries (132 Dev from validation, 132 Test from test), 448 judgments (222 Dev, 226 Test).
