...
- **Size:** 4066 documents (every distinct document in train, validation and test; train documents act as distractors), 618 queries (304 Dev from validation, 314 Test from test), 888 judgments (468 Dev, 420 Test).
