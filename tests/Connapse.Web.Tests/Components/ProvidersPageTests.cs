...
public class ProvidersPageTests
{
    ...
    public void AwsSetup_UsesOneStepCardAndReusableResetPattern()
    {
        ...
        // Three AWS step cards, the two Azure ones, and the GitHub App's, all on the same component.
        Regex.Matches(markup, "<ProviderStepCard").Should().HaveCount(6);
        markup.Should().Contain("Id=\"github-app\"");
